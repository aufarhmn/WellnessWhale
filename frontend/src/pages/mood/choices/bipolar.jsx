      ...
      <div className="w-full min-h-screen bg-green-100 flex justify-center items-center font-['Poppins'] p-4 pt-32">
        <div className="bg-white p-6 rounded-lg shadow-md w-full max-w-lg">
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              <label htmlFor="Bagaimana perasaan Anda hari ini? (Skala 1-10)" className="block text-sm font-medium mb-2">
                Bagaimana perasaan Anda hari ini? (Skala 1-10)
              </label>
              <input
                type="number"
                id="Bagaimana perasaan Anda hari ini? (Skala 1-10)"
                value={formData["Bagaimana perasaan Anda hari ini? (Skala 1-10)"]}
